...
本次只新增 OWN1 Football Tactics Lab 的展示内容，没有修改导航、原有研究主题、CV、Past Projects 或 Archive。若线上已经是上一版网站，只需上传并覆盖以下四项：

- `index.html`
- `style.css`
- `assets/own1-tactical-system.webp`
- `assets/own1-dynamic-formation.webp`

上传时保持 `assets` 文件夹结构。提交后 GitHub Pages 会自动重新部署，不需要修改 Settings → Pages。
